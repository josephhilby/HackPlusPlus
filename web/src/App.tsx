...
export default function App() {
  ...
  const loadedProgram =
    programCatalog.find((program) => program.id === machineState.programId) ??
    null;
    ...
    <main className="app-shell">
      <div className="console-stack">
        <Frame
          canvasRef={canvasRef}
          status={
            isLoadingProgram ? "Loading program..." : runtimeStatus || "Ready"
          }
        />
      ...
      {isAssemblyOpen && (
        <div className="modal-overlay" onClick={handleCloseAssemblyModal}>
          <div
