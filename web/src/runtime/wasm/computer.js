...
async function Module(moduleArg = {}) {
  ...
  function findWasmBinary() {
    if (Module["locateFile"]) {
      return locateFile("computer.wasm");
    }

    // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
    return new URL("computer.wasm", import.meta.url).href;
  }
  ...
  var _get_rom_ptr = (Module["_get_rom_ptr"] =
    makeInvalidEarlyAccess("_get_rom_ptr"));
  var _commit_rom = (Module["_commit_rom"] =
    makeInvalidEarlyAccess("_commit_rom"));
  ...
  var _set_keyboard = (Module["_set_keyboard"] =
    makeInvalidEarlyAccess("_set_keyboard"));
  var _get_state_ptr = (Module["_get_state_ptr"] =
    makeInvalidEarlyAccess("_get_state_ptr"));
  var _get_framebuffer_ptr = (Module["_get_framebuffer_ptr"] =
    makeInvalidEarlyAccess("_get_framebuffer_ptr"));
  ...
  function assignWasmExports(wasmExports) {
    assert(
      typeof wasmExports["init"] != "undefined",
      "missing Wasm export: init",
    );
    assert(
      typeof wasmExports["get_rom_ptr"] != "undefined",
      "missing Wasm export: get_rom_ptr",
    );
    assert(
      typeof wasmExports["commit_rom"] != "undefined",
      "missing Wasm export: commit_rom",
    );
    assert(
      typeof wasmExports["run"] != "undefined",
      "missing Wasm export: run",
    );
    assert(
      typeof wasmExports["stop"] != "undefined",
      "missing Wasm export: stop",
    );
    assert(
      typeof wasmExports["step"] != "undefined",
      "missing Wasm export: step",
    );
    assert(
      typeof wasmExports["reset"] != "undefined",
      "missing Wasm export: reset",
    );
    assert(
      typeof wasmExports["set_keyboard"] != "undefined",
      "missing Wasm export: set_keyboard",
    );
    assert(
      typeof wasmExports["get_state_ptr"] != "undefined",
      "missing Wasm export: get_state_ptr",
    );
    assert(
      typeof wasmExports["get_framebuffer_ptr"] != "undefined",
      "missing Wasm export: get_framebuffer_ptr",
    );
    assert(
    ...
    _get_rom_ptr = Module["_get_rom_ptr"] = createExportWrapper(
      "get_rom_ptr",
      0,
    );
    _commit_rom = Module["_commit_rom"] = createExportWrapper("commit_rom", 1);
    _run = Module["_run"] = createExportWrapper("run", 0);
    ...
    _set_keyboard = Module["_set_keyboard"] = createExportWrapper(
      "set_keyboard",
      1,
    );
    _get_state_ptr = Module["_get_state_ptr"] = createExportWrapper(
      "get_state_ptr",
      0,
    );
    _get_framebuffer_ptr = Module["_get_framebuffer_ptr"] = createExportWrapper(
      "get_framebuffer_ptr",
      0,
    );
