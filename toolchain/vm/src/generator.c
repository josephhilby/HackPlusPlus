...
/*
  ...
  To keep things readable I am adding def for the free 'registers'. When able
  refactor to the assembler table so the names can be used. Also consider TMP_A
  for 13 and alias TMP_B for 14. To help distinguish its use
 */
#define TMP "R13"
#define FRAME "R14"
#define RET "R15"
...
/*
  Generator state:
    filename         Current VM file stem. Used for static symbols and generated
  labels. current_function Current VM function scope. Used for
  label/goto/if-goto scoping. compare_id       Unique suffix for generated
  comparison labels. function_id      Unique suffix for generated return-address
  labels.
*/
...
// Dispatch Table
static const VmCommand vm_table[] = {{"push", emit_push},
                                     {"pop", emit_pop},
...
static void compare(FILE *out, const char *jump) {
  ...
  fprintf(out,
          ...
          "M=-1\n"
          "(%s)\n",
          true_label, jump, end_label, true_label, end_label);
}
