...
static void line_bounds(const std::vector<unsigned char> &v, size_t idx,
...
static std::string extract_line(const std::vector<unsigned char> &v,
                                size_t idx) {
...
static void fail_with_diff(const std::string &stem,
  ...
  FAIL() << "Mismatch: " << stem << " (instruction " << (line0 + 1) << ")\n"
...
TEST(Golden, Add) { run_golden_case("Add"); }

TEST(Golden, Stack) { run_golden_case("Stack"); }

TEST(Golden, Basic) { run_golden_case("Basic"); }

TEST(Golden, Pointer) { run_golden_case("Pointer"); }

TEST(Golden, Static) { run_golden_case("Static"); }

TEST(Golden, SimpleFunction) { run_golden_case("SimpleFunction"); }

TEST(Golden, Loop) { run_golden_case("Loop"); }

TEST(Golden, FibonacciSeries) { run_golden_case("FibonacciSeries"); }

TEST(Golden, NestedCall) { run_golden_case("Sys"); }

TEST(Golden, Statics) { run_golden_case("Statics"); }

TEST(Golden, FibonacciElement) { run_golden_case("FibonacciElement"); }
